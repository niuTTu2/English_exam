...
2011 年整卷按篇持续导入，目前已接入完形填空（16句、20题）、Text 1（19句、5题）与Text 2（30句、5题），支持自测、逐句精读、全部真实选项理由、独立词义与年度词表。第25题的转载分歧记录在解析与报告中。其余篇目只有完成精审并通过检查后才进入目录；进度与来源见 `docs/IMPORT_PROGRESS.md`。
