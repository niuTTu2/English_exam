...
'2011-p1-s2':{
 ...
 she:w('pron.','她（西蒙斯）','she apparently managed both roles','她似乎兼顾两个角色','承接西蒙斯，不是夫妻交流文章中的妻子。'),
...
'2011-p1-s5':{
 ...
 she:w('pron.','她（西蒙斯）','she said','她说道','she said标明解释来自西蒙斯本人，不指妻子。'),
...
'2011-p1-s10':{
 ...
 which:w('interrogative det.','哪些','which directors stayed','哪些董事仍留任','which限定directors共同作stayed主语，是嵌入疑问，不回指疫苗或数据库。'),
...
'2011-p1-s15':{
 ...
 it:w('pron.','这种相关性','it does not mean','这种相关性并不意味着','回指让步从句correlation，非病毒也不是形式主语。'),
...
'2011-p1-s19':{
 ...
 very:w('adv.','很','very popular on campus','在校园里很受欢迎','very修饰popular程度，不修饰few或表示正是那个。',['popular on campus']),
...
'question-201123-prompt':{according:w('fixed-expression component','根据','According to the researchers','根据研究人员','信息来源为俄亥俄大学研究者，不是其他引语人物。',['according to']),to:w('prep. / infinitive marker','根据（according to）；不定式标记','According to ... is likely to ...','根据……可能……','首处to属于according to，末尾to用于接选项动词原形；按位置分辨。'),from:w('prep.','来自','researchers from Ohio University','俄亥俄大学的研究人员','限定研究人员的机构所属。'),after:w('prep.','在……之后',"after an outside director's surprise departure",'在外部董事意外离任之后','后接名词departure给时间背景，不是世界大战结束。',['after a departure']),be:w('linking v.（is）','是；处于','the firm is likely to','公司可能……','is与likely构成系表，后面to接待选行为。')},
...
'question-201124-prompt':{it:w('formal subject','形式主语','It can be inferred that','可以推断……','It先占主语位置，真正推断内容为后置that从句；不回指公司或病毒。'),can:w('modal v.','可以','can be inferred','可以推断','can后be原形，表示在证据允许下的推断可能。'),be:w('aux.','被动标记','be inferred','被推断出','be与inferred组成被动，受can支配用原形。'),from:w('prep.','从','from the last paragraph','从最后一段','限定推断依据。'),that:w('conj.','引出推断内容','It can be inferred ... that','可以推断……','that从句是与It对应的外置内容，不在内部作主语。')},
'question-201124-option-A':{may:w('modal v.','可能','may stay','可能留任','保留可能性，不承诺所有人一定留下。'),for:w('prep.','因为；为了','stay for the attractive offers','因有吸引力的条件而留下','引留任诱因，不是保险结构。',["attractive offers from a firm"]),from:w('prep.','来自','offers from the firm','来自公司的条件','后置限定offers来源，不修饰董事来源。'),offer:w('n.（复数）','给予的条件','attractive offers from the firm','公司提供的优厚条件','offers在for后为名词复数，不是第三人称单数动词。',["attractive offers from a firm"])},
...
'question-201125-option-B':{positive:w('adj.','积极肯定的','a positive attitude','积极的态度','此处说作者评价方向，不是数字鸿沟中的positive forces。',['a positive attitude'])},
...
add('2011-p1-s1',{
 year:w('n.','年','a year later','一年之后','year表示从2000年1月向后推移的时长，不是五年增长。'),become:w('linking v.（became）','成为','became president','成为校长','became为过去时系动词，president是身份表语，不是变得商业化。'),university:w('n.（专名组成）','大学','Brown University','布朗大学','大写University属于机构专名Brown University，不是斯坦福或南加州大学。')});
add('2011-p1-s2',{decade:w('n.','十年','the rest of the decade','这十年的剩余时间','decade指进入2000年后该十年；原文没有未来十至二十年。')});
add('2011-p1-s3',{
 end:w('n.','末尾','the end of 2009','2009年底','end为时间名词，受by限定为截止点。'),under:w('prep.','处于……状态','under fire','遭到抨击','under fire为比喻性表语，不是under development发展中。',['under fire']),committee:w('n.','委员会',"Goldman's compensation committee",'高盛薪酬委员会','中心committee，compensation限定职责；不是教育委员会。',["Goldman's compensation committee"]),let:w('v.（过去分词）','让；放任','let those enormous bonus payouts pass unremarked','让巨额奖金未经质疑通过','have let中的let是过去分词；宾语payouts同时是pass的逻辑主语。'),enormous:w('adj.','巨大的','enormous bonus payouts','巨额奖金发放','修饰奖金发放规模，不是互联网潜力。')});
add('2011-p1-s4',{year:w('n.','年','the next year','次年','由前一句2009年推出2010年，配合2月作截止点。')});
add('2011-p1-s6',{serve:w('v.','充当；发挥作用','serve as advisers','充当顾问','as后接角色，on另补任职机构，不是担任陪审员。'),biased:w('adj.','有偏见的','less biased advisers','偏见较少的顾问','less降低偏见程度；不能改成全然没有任何偏向。')});
add('2011-p1-s7',{wealth:w('n.','财富','their wealth and their reputations','他们的财富与声誉','wealth和reputations共同作made宾语，本文不涉及印度贫富差异。'),elsewhere:w('adv.','在别处','made their wealth and their reputations elsewhere','在别处积累财富与声誉','elsewhere修饰made，说明不依赖当前公司积累这些资源。'),presumably:w('adv.','想必；按说','presumably have enough independence','按说有足够独立性','按财富声望来源推测，不无条件保证。'),chief:w('adj.','首席的','chief executive','首席执行官','chief前置修饰executive，为经营管理层最高主管职衔。')});
add('2011-p1-s8',{price:w('n.','价格','the share price','股价','share为名词定语，说明股票价格，与天空并列为falling主语。',['share price']),fall:w('v.-ing（present participle）','下跌；坠落','are falling','正在下跌','falling与are构成进行时，非动名词；股价下跌为实义，天塌为比喻。'),able:w('adj.','能够的','be able to give advice','能够给出建议','able为be表语，to give补足具体能力。'),give:w('v.','提出；给予','give advice','提出建议','give直接带不可数advice宾语，不是给工业带来规模效益。',['give advice']),base:w('v.-ed（past participle）','以……为依据','advice based on having weathered their own crises','基于自身危机经验的建议','based on整组后置修饰advice；此处没有显式be，不另造主句谓语。')});
add('2011-p1-s9',{researcher:w('n.（复数）','研究人员','researchers from Ohio University','俄亥俄大学研究人员','这组人使用数据库研究董事去留，不必补称政治学家。'),university:w('n.（专名组成）','大学','Ohio University','俄亥俄大学','University属于Ohio University机构名。',['Ohio University']),use:w('v.（过去式）','使用','used a database','使用了数据库','used为主动过去时谓语，非形容词习惯于。'),different:w('adj.','不同的','different directors','不同的董事','限定人数为不同个体，不是同一人重复出现的记录数。')});
add('2011-p1-s10',{simply:w('adv.','只是','simply checked','只是核查','修饰checked强调方法直接，不包含not simply but also对照。'),stay:w('v.（过去式）','留任','which directors stayed','哪些董事仍任职','stayed为不及物过去时，未接alive表语。'),one:w('determiner（数词）','一份','one proxy statement','一份委托投票说明书','one限定statement，与the next成连续两次披露，不是代替学会的ones。')});
...
add('2011-p1-s12',{find:w('v.（found）','发现','They found that','他们发现……','found为find过去式，后接that从句报告统计；没有find oneself宾补。'),company:w('n.','公司','the company will subsequently have to restate earnings','公司之后不得不重述盈利数据','指董事意外离任的原公司；不是产品品牌或投资主体泛谈。'),increase:w('v.（第三人称单数）','增加','the probability ... increases','该概率增加','increases为外层从句谓语，主语中心probability，不是修饰accumulation的increasing。'),nearly:w('adv.','将近','nearly 20%','接近20%','修饰相对增幅，不是四分之一或20个百分点。',['increases by nearly 20%'])});
add('2011-p1-s13',{federal:w('adj.','联邦的','a federal class-action lawsuit','联邦集体诉讼','限定诉讼层级，非联邦卫生官员。'),also:w('adv.','也','also increases','也增加','在财报重述风险之外再添被诉风险；位于实义动词increases前。'),increase:w('v.（第三人称单数）','增加','The likelihood ... also increases','该可能性也增加','主语likelihood说明被列入诉讼的概率，并非诉讼赔偿额。'),likely:w('adj.','可能的','is likely to perform worse','可能表现更差','likely作is表语，不定式补足具体可能事件。',['is likely to perform worse'])});
...
add('2011-p1-s15',{bad:w('adj.','不佳的','subsequent bad performance','随后不佳的表现','修饰公司表现，不是天气。'),not:w('adv.','不','does not mean ... always','不意味着总是','否定把相关性推成一概而论的命题，并不否定存在关联。'),such:w('det.','这类的','such directors','这类董事','回指前文意外离任董事；这里没有such as举例。'),ship:w('n.','船','a sinking ship','正在下沉的船','比喻前景不妙的公司；不是达尔文比喻中的船。',['jumping off a sinking ship'])});
...
add('2011-p1-s17',{researcher:w('n.（复数）','研究人员','the researchers believe','研究人员认为','明确后续解释来自研究者；不是作者第一人称观点。'),believe:w('v.','认为','believe that outside directors have','认为外部董事较容易……','显式that引完整宾语内容，说明声誉动机判断，非省略that的数字鸿沟语境。'),easy:w('adj.（easier）','较容易的','an easier time of avoiding','避免某事较容易','easier修饰time，描述行动难易；不是迁移的宾补。',['have an easier time of avoiding a blow to their reputations']),bad:w('adj.','不好的','bad news','坏消息','修饰news，指公司负面情况公开，不是恶劣天气。'),news:w('n. uncountable','消息','bad news breaks','坏消息传出','news不可数，结尾s不是复数标记，所以谓语breaks单数。',['before bad news breaks']),even:w('adv.','即使（even if）','even if a review of history shows','即使历史回顾显示','even强化if让步条件；不是even admitting结构。'),history:w('n.','历史；过去情况','a review of history','对过去情况的回顾','指回顾公司任职与违规时间，不是美国基础设施史。'),show:w('v.（shows）','显示','shows they were on the board','显示他们当时在董事会','后接省略that的内容从句，不是印度的what从句。')});
...
add('2011-p1-s19',{example:w('n.','例子；做法','the example of Ms. Simmons','西蒙斯的做法','效仿开篇西蒙斯离任选择，不是印度案例。',['follow the example of Ms. Simmons']),again:w('adv.','再度','once again','又一次','与once共同修饰popular，表个人重新受欢迎；不是句首回提论点。',['once again'])});
...
add('question-201121-option-A',{excessive:w('adj.','过多的；过度的','excessive profits','过高利润','限定profits超出合理范围，不是emphasis重视程度。')});
add('question-201121-option-B',{fulfill:w('v.','履行','fulfill her duty','履行她的职责','直接接duty宾语，题干逻辑主语为西蒙斯。'),duty:w('n.','职责','her duty','她的职责','董事的监督责任，不是陪审义务或家务。')});
add('question-201122-prompt',{paragraph:w('n.','段落','Paragraph 2','第二段','限定应有角色的信息来自第二段。')});
add('question-201123-prompt',{researcher:w('n.（复数）','研究人员','the researchers from Ohio University','俄亥俄大学的研究人员','指正文研究团队，其结果是本题依据。'),university:w('n.（专名组成）','大学','Ohio University','俄亥俄大学','机构专名组成，不是斯坦福或南加州大学。',['Ohio University']),likely:w('adj.','可能的','is likely to','可能……','likely作is表语，不定式由选项补全，非副词。')});
add('question-201124-prompt',{infer:w('v.-ed（被动分词）','推断','can be inferred','可以推断','与be构成被动，依据限定在末段；不是泛指第13题全文。'),last:w('adj.','最后的','the last paragraph','最后一段','限定段落顺序，不是去年或持续的动词。'),paragraph:w('n.','段落','the last paragraph','末段','本题推断依据为全文第四段，而非第一段。')});
