...
export const passage2010P2Sentences: SentenceAnalysis[] = [
  {
    ...
    ], clauses: [clause("that had invited men to join them", "限制性定语从句", "that", "修饰 group", "that（指 group）", "had invited", "men；to join them 是宾语补足语", "先理解‘邀请男性加入她们的’，再回到‘女性团体’。") ] },
  ...
  },
  {
    ...
    ], clauses: [clause("while his wife sat silently beside him on the couch", "while 引导的对比分句", "while", "与男子的健谈形成对照", "his wife", "sat", "无宾语；silently 是方式，beside him 和 on the couch 是地点", "先读男子不断说话，再用‘而’转到妻子的沉默。") ] },
  ...
  },
  {
    ...
    beginnerSyntax: { reading: passage2010P2Reading["2010-p2-s4"], components: [component("This man", "指示限定词 + 名词", "主语", "nodded", "This 回指前面一直健谈的那个男人。"), component("quickly", "副词", "方式状语", "nodded", "修饰点头这一动作的速度。"), component("nodded", "一般过去时动词", "谓语", "This man", "这里是不及物用法，不接宾语。"), component("in agreement", "in + 抽象名词", "态度状语", "nodded", "指出点头表示认同，而不是任意动作。")], clauses: [] },
  ...
  },
  {
    ...
    beginnerSyntax: { reading: passage2010P2Reading["2010-p2-s5"], components: [
      {
        "explanation": "两个动作都是男士做的。",
        "form": "人称代词",
        "function": "共同主语",
        "modifies": "gestured；said",
        "text": "He"
      },
      {
        "children": [
          {
            "explanation": "做手势示意，不直接接 his wife 为宾语。",
            "form": "一般过去时动词",
            "function": "谓语",
            "modifies": "He",
            "text": "gestured"
        ...
        "explanation": "先做手势，方向指向妻子。",
        "form": "动词 + 方向介词短语",
        "function": "第一个谓语及其方向状语",
        "modifies": "He",
        "text": "gestured toward his wife"
      },
      {
        "explanation": "and 并列两个动作，不是连接妻子与引语。",
        "form": "and + 过去式动词",
        "function": "第二个并列谓语",
        "modifies": "He",
        "text": "and said"
      },
      {
        "children": [
          ...
          {
            "explanation": "talker 是名词，表示爱说话的人。",
            "form": "名词短语",
            "function": "引语表语",
            "modifies": "She",
            "text": "the talker"
          ...
          {
            "explanation": "说明是他们家里话多的一方，不推断她在所有场合都话多。",
            "form": "in + 名词短语",
            "function": "范围限定",
            "modifies": "the talker",
            "text": "in our family"
        ...
        "explanation": "话中说妻子是家里爱说话的人。",
        "form": "直接引语中的系表句",
        "function": "说话内容",
        "modifies": "said",
        "text": "She's the talker in our family"
      }
    ], clauses: [clause("She's the talker in our family", "直接引语内容分句", "引号；无从属连词", "作为 said 的直接引语内容", "She", "is（缩写在 She's 中）", "the talker", "先译她是爱说话的人，再交代‘在我们家’的范围。") ] },
  ...
  },
  {
    ...
    beginnerSyntax: { reading: passage2010P2Reading["2010-p2-s6"], components: [
      ...
      {
        "explanation": "与 burst 合成‘突然大笑’；laughter 不可数。",
        "form": "into + 名词",
        "function": "状态补足语",
        "modifies": "burst",
        "text": "into laughter"
  ...
  },
  {
    ...
    beginnerSyntax: { reading: passage2010P2Reading["2010-p2-s7"], components: [component("It's true", "直接引语中的系表句", "直接引语内容", "explained", "It 作主语，is 是系动词，true 作表语，表示前面的说法属实。"), component("he", "人称代词", "报告分句主语", "explained", "说明解释的人是这位男士。"), component("explained", "一般过去时动词", "报告分句谓语", "he", "其说明内容放在前面的引号里。")], clauses: [clause("It's true", "直接引语内容分句", "引号；无从属连词", "作为 explained 的直接引语内容", "It", "is（缩写在 It's 中）", "true", "先读‘这是真的’，再读叙述者补充的‘他解释道’。") ] },
  ...
  },
  {
    ...
    ], clauses: [clause("When I come home from work", "时间状语从句", "When", "修饰主句 have nothing to say", "I", "come", "无宾语；home 表方向，from work 表来处", "先说‘当我下班回家时’，再说没有话可说。") ] },
  ...
  },
  {
    ...
    beginnerSyntax: { reading: passage2010P2Reading["2010-p2-s9"], components: [
      ...
      {
        "explanation": "后面是 spend 原形，所以 'd 不是 had。",
        "form": "we + would 的缩写",
        "function": "主句主语及情态助动词",
        "modifies": "spend",
        "text": "we'd"
    ...
    ], clauses: [clause("If she didn't keep the conversation going", "虚拟条件状语从句", "If", "给 would spend 提供与现实相反的条件", "she", "didn't keep", "the conversation；going 作宾语补足语", "先译‘要不是她让谈话继续’，再译‘我们就会……’。") ] },
  ...
  },
  {
    ...
    ], clauses: [clause("He doesn't listen to me", "直接引语中的内容分句", "冒号及引号；无从属连词", "举例说明沟通抱怨", "He", "doesn't listen", "to me 为倾听对象", "先译‘他不听’，再译对象‘我说话’。") ] },
  ...
  },
  {
    ...
    beginnerSyntax: { reading: passage2010P2Reading["2010-p2-s17"], components: [component("He", "人称代词", "主语", "doesn't talk", "在妻子的直接引语中指丈夫。"), component("doesn't talk", "助动词否定式 + 动词原形", "谓语", "He", "描述惯常不交谈的情况，doesn't 承担第三人称单数变化。"), component("to me", "to + 宾格代词", "交谈对象补足语", "talk", "me 是妻子，保留这一对象才能体现家庭沟通问题。")], clauses: [] },
