...
export const passage2010P1Sentences: SentenceAnalysis[] = [
  ...
  },
  {
    ...
    beginnerSyntax: { reading: passage2010P1Reading["2010-p1-s4"], components: [
      ...
      ], clauses: [clause("As the auctioneer called out bids", "时间/伴随状语从句", "As", "为主句提供同步发生的背景", "the auctioneer", "called out", "bids（宾语）", "先译‘就在拍卖师报出竞价时’，再译纽约发生的主句。") ] },
  ...
  },
  {
    ...
    chunks: [{ text: "At its peak in 2007", role: "modifier" }, { text: " it", role: "subject" }, { text: " was", role: "predicate" }, { text: " worth some $65 billion", role: "object" }, { text: ", reckons Clare McAndrew, founder of Arts Economics, a research firm", role: "modifier" }, { text: " – double the figure five years earlier.", role: "modifier" }],
  ...
  },
  {
    ...
    beginnerSyntax: { reading: passage2010P1Reading["2010-p1-s8"], components: [
      ...
      ], clauses: [clause("because it brings together great wealth, enormous egos, greed, passion and controversy in a way matched by few other industries", "原因状语从句", "because", "解释市场格外引人关注的原因", "it（the market）", "brings together", "great wealth, enormous egos, greed, passion and controversy（并列宾语）；in a way matched by few other industries（方式状语）", "先译主句结论，再用‘因为’引出五项原因。") ] },
  ...
  },
  {
    ...
    beginnerSyntax: { reading: passage2010P1Reading["2010-p1-s9"], components: [
      ...
      ], clauses: [clause("that followed Mr. Hirst's sale", "限制性定语从句", "that", "限定 weeks and months", "that（= weeks and months）", "followed", "Mr. Hirst's sale（宾语）", "先译中心词‘数周和数月’，再前置为‘赫斯特拍卖之后的数周和数月’。") ] },
  ...
  },
  {
    ...
    beginnerSyntax: { reading: passage2010P1Reading["2010-p1-s12"], components: [
      ...
      ], clauses: [clause("who had placed works for sale with them", "限制性定语从句", "who", "修饰 clients", "who（= clients）", "had placed", "works（宾语）；for sale / with them（补充状态与受托方）", "先译成‘客户’，再前置为‘曾把作品交给两家拍卖行出售的客户’。") ] },
  ...
  },
  {
    ...
    beginnerSyntax: { reading: passage2010P1Reading["2010-p1-s13"], components: [
      ...
      ], clauses: [clause("since the Japanese stopped buying Impressionists at the end of 1989", "时间状语从句", "since", "给最高级 worst 划定从1989年底至今的范围", "the Japanese", "stopped", "buying Impressionists（动名词宾语）；at the end of 1989（时间状语）", "先译主句‘是最严重的一次’，再补‘自1989年底……以来’。") ] },
  ...
  },
  {
    ...
    beginnerSyntax: { reading: passage2010P1Reading["2010-p1-s14"], components: [
      ...
      ], clauses: [clause("that prices are about 40% down on their peak on average", "宾语从句", "that", "作 reckon 的内容宾语", "prices", "are", "about 40% down（表语）；on their peak（比较基准）；on average（统计状语）", "先译‘专家估计’，再译完整判断‘价格平均比峰值低约40%’。"), clause("though some have been far more fluctuant", "让步状语从句", "though", "补充不受平均值完全概括的个别情况", "some（prices）", "have been", "far more fluctuant（表语）", "主句后补‘尽管有些价格的波动要大得多’。") ] },
  ...
  },
  {
    ...
    beginnerSyntax: { reading: passage2010P1Reading["2010-p1-s16"], components: [
      ...
      ], clauses: [clause("What makes this slump different from the last", "融合型关系主语从句", "What（= the thing that）", "整体作主句主语", "What", "makes", "this slump（宾语）+ different from the last（宾语补足语）", "整体先译为‘使本轮低迷不同于上次的地方’，再接 is 后答案。"), clause("that there are still buyers in the market", "表语从句", "that", "作 is 的表语，给出差异内容", "buyers（there be 的实际主语）", "are", "still / in the market（状语）", "译为‘市场中仍然存在买家’。") ] },
  ...
  },
  {
    ...
    beginnerSyntax: { reading: passage2010P1Reading["2010-p1-s19"], components: [
      ...
      ], clauses: [clause("who does not have to sell", "限制性定语从句", "who", "修饰 anyone", "who（= anyone）", "does not have to sell", "无直接宾语（sell 在语境中指卖作品）", "译成‘不必非卖不可的人’放在 anyone 前。") ] },
