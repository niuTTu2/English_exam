...
import { reviewedSenses2013P4, reviewedAnnotations2013P4 } from "./reviewed-senses-2013-p4";
...
export const reviewedSenseTables: readonly ReviewedSenseTable[] = [reviewedSenses2014P1, reviewedSensesGlobal, reviewedSenses2013P4, reviewedSenses2013P3, reviewedSenses2013, reviewedSensesAF, reviewedSensesGM, reviewedSensesNS, reviewedSensesTZ, reviewedSensesFunction];
export const reviewedAnnotationTables: readonly ReviewedSenseAnnotations[] = [reviewedAnnotations2014P1, reviewedAnnotations2013P4, reviewedAnnotations2013, reviewedAnnotationsAF, reviewedAnnotationsGM, reviewedAnnotationsNS, reviewedAnnotationsTZ, reviewedAnnotationsFunction];
