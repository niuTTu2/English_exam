...
const definitions: Definition[] = [
  ...
  d("consists-of", "consists of", "consist of + components", "动词介词搭配", "由……组成", "不及物动词加介词 of", "consist of 后接组成部分，主语是整体；通常不使用被动 *be consisted of。", "The course consists of six units.", "这门课程由六个单元组成。", ["consist 后固定用 of；comprise 可直接接组成部分，不能机械套用 consist 的语序。"]),
