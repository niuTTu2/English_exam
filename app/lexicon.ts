...
export function getLexicalGuide(token: string, context?: LexicalContext): LexicalGuide {
  ...
  const formContext = context?.articleId === "2013-p4" && sourceId ? passage2013P4FormContexts[sourceId]?.[normalized] : context?.articleId === "p3" && sourceId ? passage3FormContexts[sourceId]?.[normalized] : context?.articleId === "p4" && sourceId ? passage4FormContexts[sourceId]?.[normalized] : context?.articleId === "2011-p2" ? getPassage2011P2FormContext(normalized, sourceId) : undefined;
  ...
  const contextualPos = sentenceContext?.partOfSpeech ?? (context?.articleId === "2014-p1" ? articleEntry?.partOfSpeech : undefined) ?? pos;
