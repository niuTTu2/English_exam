...
export function getLexicalGuide(token: string, context?: LexicalContext): LexicalGuide {
  ...
  return {
    ...
    collocations: Array.from(new Set([...(passage2011P4Extra?.collocations ?? []), ...(passage2011P3Extra?.collocations ?? []), ...(passage2011P2Extra?.collocations ?? []), ...(passage2011P1Extra?.collocations ?? []), ...(cloze2011Extra?.collocations ?? []), ...(translation2010Extra?.collocations ?? []), ...(passage2010P5Extra?.collocations ?? []), ...(passage2010P2Extra?.collocations ?? []), ...(cloze2010Entry?.collocations ?? []), ...(passage2010P1Entry?.collocations ?? []), ...mergedCollocations])),
    otherMeanings: Array.from(new Set([...(passage2011P4Extra?.otherMeanings ?? []), ...(passage2011P3Extra?.otherMeanings ?? []), ...(passage2011P2Extra?.otherMeanings ?? []), ...(passage2011P1Extra?.otherMeanings ?? []), ...(cloze2011Extra?.otherMeanings ?? []), ...(passage2010P2Extra?.otherMeanings ?? []), ...(cloze2010Entry?.otherMeanings ?? []), ...(passage2010P1Entry?.otherMeanings ?? []), ...mergedMeanings])),
