...
export function canonicalLemma(token: string, context?: LexicalContext) {
  ...
  return (context?.articleId === "2010-p5" ? passage2010P5LemmaAliases[normalized] : undefined) ?? (context?.articleId === "2010-p4" ? passage2010P4LemmaAliases[normalized] : undefined) ?? (context?.articleId === "2010-p3" ? passage2010P3LemmaAliases[normalized] : undefined) ?? (sourceId ? sourceLemmaAliases[sourceId]?.[normalized] : undefined) ?? lemmaAliases[normalized] ?? (!context?.articleId ? cloze2011LemmaAliases[normalized] ?? writing2012BLemmaAliases[normalized] ?? writing2012ALemmaAliases[normalized] ?? (normalized === "best" || normalized === "better" ? undefined : translation2012LemmaAliases[normalized]) ?? passage2012P5LemmaAliases[normalized] ?? passage2012P4LemmaAliases[normalized] ?? passage2012P3LemmaAliases[normalized] ?? passage2012P1LemmaAliases[normalized] ?? cloze2012LemmaAliases[normalized] ?? passage2011P1LemmaAliases[normalized] ?? passage2011P2LemmaAliases[normalized] ?? passage2011P3LemmaAliases[normalized] ?? passage2011P4LemmaAliases[normalized] ?? passage2011P5LemmaAliases[normalized] ?? translation2011LemmaAliases[normalized] ?? writing2011ALemmaAliases[normalized] ?? writing2011BLemmaAliases[normalized] : undefined) ?? normalized;
}
...
export function getLexicalGuide(token: string, context?: LexicalContext): LexicalGuide {
  ...
  return {
    ...
    collocations: Array.from(new Set([...(writing2012BExtra?.collocations ?? []), ...(writing2012AExtra?.collocations ?? []), ...(translation2012Extra?.collocations ?? []), ...(passage2012P5Extra?.collocations ?? []), ...(passage2012P4Extra?.collocations ?? []), ...(passage2012P3Extra?.collocations ?? []), ...(passage2012P1Extra?.collocations ?? []), ...(cloze2012Extra?.collocations ?? []), ...(writing2011BExtra?.collocations ?? []), ...(writing2011AExtra?.collocations ?? []), ...(translation2011Extra?.collocations ?? []), ...(passage2011P5Extra?.collocations ?? []), ...(passage2011P4Extra?.collocations ?? []), ...(passage2011P3Extra?.collocations ?? []), ...(passage2011P2Extra?.collocations ?? []), ...(passage2011P1Extra?.collocations ?? []), ...(cloze2011Extra?.collocations ?? []), ...(translation2010Extra?.collocations ?? []), ...(passage2010P5Extra?.collocations ?? []), ...(passage2010P2Extra?.collocations ?? []), ...(cloze2010Entry?.collocations ?? []), ...(passage2010P1Entry?.collocations ?? []), ...mergedCollocations])),
    otherMeanings: Array.from(new Set([...(writing2012BExtra?.otherMeanings ?? []), ...(writing2012AExtra?.otherMeanings ?? []), ...(translation2012Extra?.otherMeanings ?? []), ...(passage2012P5Extra?.otherMeanings ?? []), ...(passage2012P4Extra?.otherMeanings ?? []), ...(passage2012P3Extra?.otherMeanings ?? []), ...(passage2012P1Extra?.otherMeanings ?? []), ...(cloze2012Extra?.otherMeanings ?? []), ...(writing2011BExtra?.otherMeanings ?? []), ...(writing2011AExtra?.otherMeanings ?? []), ...(translation2011Extra?.otherMeanings ?? []), ...(passage2011P5Extra?.otherMeanings ?? []), ...(passage2011P4Extra?.otherMeanings ?? []), ...(passage2011P3Extra?.otherMeanings ?? []), ...(passage2011P2Extra?.otherMeanings ?? []), ...(passage2011P1Extra?.otherMeanings ?? []), ...(cloze2011Extra?.otherMeanings ?? []), ...(passage2010P2Extra?.otherMeanings ?? []), ...(cloze2010Entry?.otherMeanings ?? []), ...(passage2010P1Entry?.otherMeanings ?? []), ...mergedMeanings])),
