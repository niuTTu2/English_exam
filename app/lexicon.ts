...
export function getLexicalGuide(token: string, context?: LexicalContext): LexicalGuide {
  ...
  const chronologicalEntry: typeof passage1Entry | undefined = ordinal || decade ? {
    ...
    specialForms: passage2012P1Extra ? passage2012P1Extra.specialForms : cloze2012Extra ? cloze2012Extra.specialForms : [ordinal ? "序数数字与st/nd/rd/th后缀不可拆分；不是普通单复数变化。" : "年代标记s不是普通名词复数；数字部分必须整体保留。"],
    examSynonyms: passage2012P1Extra ? passage2012P1Extra.examSynonyms : cloze2012Extra ? cloze2012Extra.examSynonyms : [],
  } : undefined;
