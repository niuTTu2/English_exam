import {lexicon as p2014P3Lexicon,aliases as p2014P3Aliases,formContexts as p2014P3FormContexts} from "./2014-passage-3-vocabulary";
import {lexicon as p2014P2Lexicon,aliases as p2014P2Aliases,formContexts as p2014P2FormContexts} from "./2014-passage-2-vocabulary";
...
import { writing2012BLexicon, writing2012BLemmaAliases, writing2012BFormPartOfSpeech } from "./2012-writing-b-lexicon";
import { writing2012ALexicon, writing2012ALemmaAliases, writing2012AFormPartOfSpeech } from "./2012-writing-a-lexicon";
import { translation2012Lexicon, translation2012LemmaAliases, translation2012FormPartOfSpeech } from "./2012-translation-lexicon";
import { passage2012P5Lexicon, passage2012P5LemmaAliases, passage2012P5FormPartOfSpeech } from "./2012-passage-5-lexicon";
import { passage2012P4Lexicon, passage2012P4LemmaAliases, passage2012P4FormPartOfSpeech } from "./2012-passage-4-lexicon";
import { passage2012P3Lexicon, passage2012P3LemmaAliases, passage2012P3FormPartOfSpeech } from "./2012-passage-3-lexicon";
import { passage2012P2Lexicon, passage2012P2LemmaAliases, passage2012P2FormPartOfSpeech } from "./2012-passage-2-lexicon";
import { passage2012P1Lexicon, passage2012P1LemmaAliases, passage2012P1FormPartOfSpeech } from "./2012-passage-1-lexicon";
import { cloze2012Lexicon, cloze2012LemmaAliases, cloze2012FormPartOfSpeech } from "./2012-cloze-lexicon";
import { writing2011BLexicon, writing2011BLemmaAliases, writing2011BFormPartOfSpeech } from "./2011-writing-b-lexicon";
import { writing2011ALexicon, writing2011ALemmaAliases, writing2011AFormPartOfSpeech } from "./2011-writing-a-lexicon";
import { translation2011Lexicon, translation2011LemmaAliases, translation2011FormPartOfSpeech } from "./2011-translation-lexicon";
import { passage2011P5Lexicon, passage2011P5LemmaAliases, passage2011P5FormPartOfSpeech } from "./2011-passage-5-lexicon";
import { passage2011P4Lexicon, passage2011P4LemmaAliases, passage2011P4FormPartOfSpeech } from "./2011-passage-4-lexicon";
import { passage2011P3Lexicon, passage2011P3LemmaAliases, passage2011P3FormPartOfSpeech } from "./2011-passage-3-lexicon";
import { passage2011P2Lexicon, passage2011P2LemmaAliases, passage2011P2FormPartOfSpeech } from "./2011-passage-2-lexicon";
import { passage2011P1Lexicon, passage2011P1LemmaAliases, passage2011P1FormPartOfSpeech } from "./2011-passage-1-lexicon";
import { cloze2011Lexicon, cloze2011LemmaAliases, cloze2011FormPartOfSpeech } from "./2011-cloze-lexicon";
import { translation2010Lexicon, translation2010LemmaAliases, translation2010FamilyAliases, translation2010FormPartOfSpeech } from "./2010-translation-lexicon";
import { passage2010P5Lexicon, passage2010P5LemmaAliases, passage2010P5FamilyAliases, passage2010P5FormPartOfSpeech } from "./2010-passage-5-lexicon";
...
import {
  passage3FamilyAliases,
  passage3FormPartOfSpeech,
...
import {
  passage5FamilyAliases,
  passage5FormPartOfSpeech,
  passage5LemmaAliases,
  passage5Lexicon,
} from "./passage-5-lexicon";
import {
  translationFamilyAliases,
  translationFormPartOfSpeech,
  translationLemmaAliases,
  translationLexicon,
} from "./translation-lexicon";
import {
  cloze2001FormPartOfSpeech,
  cloze2001LemmaAliases,
  cloze2001Lexicon,
} from "./2001-cloze-lexicon";
import {
  passage2001P1FamilyAliases,
  passage2001P1FormPartOfSpeech,
  passage2001P1LemmaAliases,
  passage2001P1Lexicon,
} from "./2001-passage-1-lexicon";
import {
  passage2001P2FamilyAliases,
  passage2001P2FormPartOfSpeech,
  passage2001P2LemmaAliases,
...
import {
  passage2010P2FamilyAliases,
  passage2010P2FormPartOfSpeech,
  passage2010P2LemmaAliases,
  passage2010P2Lexicon,
} from "./2010-passage-2-lexicon";
import {
...
Object.assign(lemmaAliases, passage2010P2LemmaAliases);
for (const [form, lemma] of Object.entries(passage2010P3LemmaAliases)) {
  if (!lemmaAliases[form] && !["best", "better"].includes(form)) lemmaAliases[form] = lemma;
}
...
Object.assign(familyAliases, passage2010P5FamilyAliases);
for (const [word, family] of Object.entries(translation2010FamilyAliases)) {
  if (!familyAliases[word]) familyAliases[word] = family;
}
for (const form of ["recalls", "selling", "signed", "translated"]) {
  if (!lemmaAliases[form]) lemmaAliases[form] = translation2010LemmaAliases[form];
}
for (const [form, lemma] of Object.entries(passage2010P5LemmaAliases)) {
  if (form !== lemma && lemma !== "he" && lemma !== "they" && !lemmaAliases[form]) lemmaAliases[form] = lemma;
}
...
for (const [key, value] of Object.entries(passage5LemmaAliases)) {
  if (!lemmaAliases[key]) lemmaAliases[key] = value;
}
for (const [key, value] of Object.entries(passage5FamilyAliases)) {
  if (!familyAliases[key]) familyAliases[key] = value;
}
for (const [key, value] of Object.entries(passage5FormPartOfSpeech)) {
  if (!formPartOfSpeech[key]) formPartOfSpeech[key] = value;
}
Object.assign(lemmaAliases, translationLemmaAliases);
Object.assign(lemmaAliases, passage2001P1LemmaAliases);
Object.assign(familyAliases, passage2001P1FamilyAliases);
Object.assign(formPartOfSpeech, passage2001P1FormPartOfSpeech);
Object.assign(lemmaAliases, passage2001P2LemmaAliases);
Object.assign(familyAliases, passage2001P2FamilyAliases);
Object.assign(formPartOfSpeech, passage2001P2FormPartOfSpeech);
...
const sourceLemmaAliases: Record<string, Record<string, string>> = {
  ...
  "p2-s19": { means: "mean" },
  "p2-s20": { means: "mean" },
  "question-201027-prompt": { means: "mean" },
};

export function canonicalLemma(token: string, context?: LexicalContext) {
  const normalized = token.trim().toLowerCase().replace(/[’‘]/g, "'");
  if (context?.articleId === "2014-p3" && p2014P3Aliases[normalized]) return p2014P3Aliases[normalized];
  ...
  if (context?.articleId === "2012-cloze" && cloze2012LemmaAliases[normalized]) return cloze2012LemmaAliases[normalized];
  if (context?.articleId === "2012-p1" && passage2012P1LemmaAliases[normalized]) return passage2012P1LemmaAliases[normalized];
  if (context?.articleId === "2012-p2" && passage2012P2LemmaAliases[normalized]) return passage2012P2LemmaAliases[normalized];
  if (context?.articleId === "2012-p3") {
    const sourceLemma = sourceLemmaAliases[context.sourceId ?? context.sentenceId ?? ""]?.[normalized];
    if (sourceLemma) return sourceLemma;
    if (passage2012P3LemmaAliases[normalized]) return passage2012P3LemmaAliases[normalized];
  }
  if (context?.articleId === "2012-p4" && passage2012P4LemmaAliases[normalized]) return passage2012P4LemmaAliases[normalized];
  if (context?.articleId === "2012-p5" && passage2012P5LemmaAliases[normalized]) return passage2012P5LemmaAliases[normalized];
  if (context?.articleId === "2012-translation" && translation2012LemmaAliases[normalized]) return translation2012LemmaAliases[normalized];
  if (context?.articleId === "2012-writing-a" && writing2012ALemmaAliases[normalized]) return writing2012ALemmaAliases[normalized];
  if (context?.articleId === "2012-writing-b" && writing2012BLemmaAliases[normalized]) return writing2012BLemmaAliases[normalized];
...
export function getLexicalGuide(token: string, context?: LexicalContext): LexicalGuide {
  ...
  const passage2010P5Entry = passage2010P5Lexicon[headword];
  const translation2010Entry = translation2010Lexicon[headword];
  const cloze2012Entry = cloze2012Lexicon[headword];
  const cloze2012Extra = context?.articleId && context.articleId !== "2012-cloze" ? undefined : cloze2012Entry;
  const passage2012P1Entry = passage2012P1Lexicon[headword];
  const passage2012P1Extra = context?.articleId && context.articleId !== "2012-p1" ? undefined : passage2012P1Entry;
  const passage2012P2Entry = passage2012P2Lexicon[headword];
  const passage2012P2Extra = context?.articleId && context.articleId !== "2012-p2" ? undefined : passage2012P2Entry;
  const passage2012P3Entry = passage2012P3Lexicon[headword];
  const passage2012P3Extra = context?.articleId && context.articleId !== "2012-p3" ? undefined : passage2012P3Entry;
  const passage2012P4Entry = passage2012P4Lexicon[headword];
  const passage2012P4Extra = context?.articleId && context.articleId !== "2012-p4" ? undefined : passage2012P4Entry;
  const passage2012P5Entry = passage2012P5Lexicon[headword];
  const passage2012P5Extra = context?.articleId && context.articleId !== "2012-p5" ? undefined : passage2012P5Entry;
  const translation2012Entry = translation2012Lexicon[headword];
  const translation2012Extra = context?.articleId && context.articleId !== "2012-translation" ? undefined : translation2012Entry;
  const writing2012AEntry = writing2012ALexicon[headword];
  const writing2012AExtra = context?.articleId && context.articleId !== "2012-writing-a" ? undefined : writing2012AEntry;
  const writing2012BEntry = writing2012BLexicon[headword];
  const writing2012BExtra = context?.articleId && context.articleId !== "2012-writing-b" ? undefined : writing2012BEntry;
  const cloze2011Entry = cloze2011Lexicon[headword];
  const passage2011P1Entry = passage2011P1Lexicon[headword];
  const writing2011BEntry = writing2011BLexicon[headword];
  const writing2011BExtra = context?.articleId && context.articleId !== "2011-writing-b" ? undefined : writing2011BEntry;
  const writing2011AEntry = writing2011ALexicon[headword];
  const writing2011AExtra = context?.articleId && context.articleId !== "2011-writing-a" ? undefined : writing2011AEntry;
  const translation2011Entry = translation2011Lexicon[headword];
  const passage2011P5Entry = passage2011P5Lexicon[headword];
  const passage2011P4Entry = passage2011P4Lexicon[headword];
  const passage2011P3Entry = passage2011P3Lexicon[headword];
  const passage2011P2Entry = passage2011P2Lexicon[headword];
  const translation2011Extra = context?.articleId && context.articleId !== "2011-translation" ? undefined : translation2011Entry;
  const passage2011P5Extra = context?.articleId && context.articleId !== "2011-p5" ? undefined : passage2011P5Entry;
  const passage2011P4Extra = context?.articleId && context.articleId !== "2011-p4" ? undefined : passage2011P4Entry;
  const passage2011P3Extra = context?.articleId && context.articleId !== "2011-p3" ? undefined : passage2011P3Entry;
  const passage2011P2Extra = context?.articleId && context.articleId !== "2011-p2" ? undefined : passage2011P2Entry;
  const passage2011P1Extra = context?.articleId && context.articleId !== "2011-p1" ? undefined : passage2011P1Entry;
  const cloze2011Extra = context?.articleId && context.articleId !== "2011-cloze" ? undefined : cloze2011Entry;
  const translation2010Extra = context?.articleId && context.articleId !== "2010-translation" ? undefined : translation2010Entry;
  const passage2010P5Extra = context?.articleId && context.articleId !== "2010-p5" ? undefined : passage2010P5Entry;
  ...
  const articleEntries = {
    ...
    "2010-p5": passage2010P5Entry,
    "2010-translation": translation2010Entry,
    "2012-cloze": cloze2012Entry,
    "2012-p1": passage2012P1Entry,
    "2012-p2": passage2012P2Entry,
    "2012-p3": passage2012P3Entry,
    "2012-p4": passage2012P4Entry,
    "2012-p5": passage2012P5Entry,
    ...
    "2014-p3": p2014P3Lexicon[headword],
    ...
    "2011-writing-a": writing2011AEntry,
    "2011-translation": translation2011Entry,
    "2011-p5": passage2011P5Entry,
    "2011-p4": passage2011P4Entry,
    "2011-p3": passage2011P3Entry,
  ...
  return {
    ...
    otherMeanings: Array.from(new Set([...(writing2012BExtra?.otherMeanings ?? []), ...(writing2012AExtra?.otherMeanings ?? []), ...(translation2012Extra?.otherMeanings ?? []), ...(passage2012P5Extra?.otherMeanings ?? []), ...(passage2012P4Extra?.otherMeanings ?? []), ...(passage2012P3Extra?.otherMeanings ?? []), ...(passage2012P2Extra?.otherMeanings ?? []), ...(passage2012P1Extra?.otherMeanings ?? []), ...(cloze2012Extra?.otherMeanings ?? []), ...(writing2011BExtra?.otherMeanings ?? []), ...(writing2011AExtra?.otherMeanings ?? []), ...(translation2011Extra?.otherMeanings ?? []), ...(passage2011P5Extra?.otherMeanings ?? []), ...(passage2011P4Extra?.otherMeanings ?? []), ...(passage2011P3Extra?.otherMeanings ?? []), ...(passage2011P2Extra?.otherMeanings ?? []), ...(passage2011P1Extra?.otherMeanings ?? []), ...(cloze2011Extra?.otherMeanings ?? []), ...(passage2010P2Extra?.otherMeanings ?? []), ...(cloze2010Entry?.otherMeanings ?? []), ...(passage2010P1Entry?.otherMeanings ?? []), ...mergedMeanings])),
    ...
    confusions: Array.from(new Set([...(passage2010P3Extra?.confusions ?? []), ...(passage2010P2Extra?.confusions ?? []), ...(cloze2010Entry?.confusions ?? []), ...(passage2010P1Entry?.confusions ?? []), ...mergedConfusions])),
    contextualSubstitutions: sentenceContext?.contextualSubstitutions ?? passageEntry?.contextualSubstitutions ?? [],
    ...(context?.articleId === "2014-p1" && p2014P1Lexicon[headword] ? {specialForms:p2014P1Lexicon[headword].specialForms,examSynonyms:p2014P1Lexicon[headword].examSynonyms,collocations:p2014P1Lexicon[headword].collocations} : {}),
    ...(context?.articleId === "2014-p2" && p2014P2Lexicon[headword] ? {specialForms:p2014P2Lexicon[headword].specialForms,examSynonyms:p2014P2Lexicon[headword].examSynonyms,collocations:p2014P2Lexicon[headword].collocations} : {}),
    ...(context?.articleId === "2014-p3" && p2014P3Lexicon[headword] ? {specialForms:p2014P3Lexicon[headword].specialForms,examSynonyms:p2014P3Lexicon[headword].examSynonyms,collocations:p2014P3Lexicon[headword].collocations} : {}),
  };
}
