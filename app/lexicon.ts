...
export function getLexicalGuide(token: string, context?: LexicalContext): LexicalGuide {
  ...
  const chronologicalEntry: typeof passage1Entry | undefined = ordinal || decade ? {
    ...
    specialForms: passage2012P3Extra ? passage2012P3Extra.specialForms : passage2012P1Extra ? passage2012P1Extra.specialForms : cloze2012Extra ? cloze2012Extra.specialForms : [ordinal ? "序数数字与st/nd/rd/th后缀不可拆分；不是普通单复数变化。" : "年代标记s不是普通名词复数；数字部分必须整体保留。"],
    examSynonyms: passage2012P3Extra ? passage2012P3Extra.examSynonyms : passage2012P1Extra ? passage2012P1Extra.examSynonyms : cloze2012Extra ? cloze2012Extra.examSynonyms : [],
  } : undefined;
  ...
  return {
    ...
    collocations: Array.from(new Set([...(passage2012P3Extra?.collocations ?? []), ...(passage2012P1Extra?.collocations ?? []), ...(cloze2012Extra?.collocations ?? []), ...(writing2011BExtra?.collocations ?? []), ...(writing2011AExtra?.collocations ?? []), ...(translation2011Extra?.collocations ?? []), ...(passage2011P5Extra?.collocations ?? []), ...(passage2011P4Extra?.collocations ?? []), ...(passage2011P3Extra?.collocations ?? []), ...(passage2011P2Extra?.collocations ?? []), ...(passage2011P1Extra?.collocations ?? []), ...(cloze2011Extra?.collocations ?? []), ...(translation2010Extra?.collocations ?? []), ...(passage2010P5Extra?.collocations ?? []), ...(passage2010P2Extra?.collocations ?? []), ...(cloze2010Entry?.collocations ?? []), ...(passage2010P1Entry?.collocations ?? []), ...mergedCollocations])),
    otherMeanings: Array.from(new Set([...(passage2012P3Extra?.otherMeanings ?? []), ...(passage2012P1Extra?.otherMeanings ?? []), ...(cloze2012Extra?.otherMeanings ?? []), ...(writing2011BExtra?.otherMeanings ?? []), ...(writing2011AExtra?.otherMeanings ?? []), ...(translation2011Extra?.otherMeanings ?? []), ...(passage2011P5Extra?.otherMeanings ?? []), ...(passage2011P4Extra?.otherMeanings ?? []), ...(passage2011P3Extra?.otherMeanings ?? []), ...(passage2011P2Extra?.otherMeanings ?? []), ...(passage2011P1Extra?.otherMeanings ?? []), ...(cloze2011Extra?.otherMeanings ?? []), ...(passage2010P2Extra?.otherMeanings ?? []), ...(cloze2010Entry?.otherMeanings ?? []), ...(passage2010P1Entry?.otherMeanings ?? []), ...mergedMeanings])),
