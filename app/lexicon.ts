...
export function getLexicalGuide(token: string, context?: LexicalContext): LexicalGuide {
  ...
  return {
    ...
    specialForms: passage2011P2Extra ? passage2011P2Extra.specialForms : passage2011P1Extra ? passage2011P1Extra.specialForms : cloze2011Extra ? cloze2011Extra.specialForms : context?.articleId === "2010-translation" && translation2010Extra ? translation2010Extra.specialForms : Array.from(new Set([...(translation2010Extra?.specialForms ?? []), ...(passage2010P5Extra?.specialForms ?? []), ...(passage2010P4Extra?.specialForms ?? []), ...(passage2010P3Extra?.specialForms ?? []), ...(passage2010P2Extra?.specialForms ?? []), ...(cloze2010Entry?.specialForms ?? []), ...(passage2010P1Entry?.specialForms ?? []), ...(mergedSpecialForms.length > 0 ? mergedSpecialForms : [isStructureWord ? "结构词：无普通词形变化，重点看句法位置" : "无需要单独记忆的不规则变形"])])),
    examSynonyms: passage2011P2Extra ? passage2011P2Extra.examSynonyms : passage2011P1Extra ? passage2011P1Extra.examSynonyms : cloze2011Extra ? cloze2011Extra.examSynonyms : context?.articleId === "2010-translation" && translation2010Extra ? translation2010Extra.examSynonyms : context?.articleId === "2010-p5" && passage2010P5Extra ? passage2010P5Extra.examSynonyms : context?.articleId === "2010-p4" && passage2010P4Extra ? passage2010P4Extra.examSynonyms : context?.articleId === "2010-p3" && passage2010P3Extra ? passage2010P3Extra.examSynonyms : Array.from(new Set([...(translation2010Extra?.examSynonyms ?? []), ...(passage2010P5Extra?.examSynonyms ?? []), ...(passage2010P4Extra?.examSynonyms ?? []), ...(passage2010P3Extra?.examSynonyms ?? []), ...(passage2010P2Extra?.examSynonyms ?? []), ...(cloze2010Entry?.examSynonyms ?? []), ...(passage2010P1Entry?.examSynonyms ?? []), ...(mergedExamSynonyms.length > 0 ? mergedExamSynonyms : [isStructureWord ? "结构词通常不能脱离句型直接替换" : "本词暂无需要成组强记的考研近义词"])])),
    collocations: Array.from(new Set([...(passage2011P2Extra?.collocations ?? []), ...(passage2011P1Extra?.collocations ?? []), ...(cloze2011Extra?.collocations ?? []), ...(translation2010Extra?.collocations ?? []), ...(passage2010P5Extra?.collocations ?? []), ...(passage2010P2Extra?.collocations ?? []), ...(cloze2010Entry?.collocations ?? []), ...(passage2010P1Entry?.collocations ?? []), ...mergedCollocations])),
    otherMeanings: Array.from(new Set([...(passage2011P2Extra?.otherMeanings ?? []), ...(passage2011P1Extra?.otherMeanings ?? []), ...(cloze2011Extra?.otherMeanings ?? []), ...(passage2010P2Extra?.otherMeanings ?? []), ...(cloze2010Entry?.otherMeanings ?? []), ...(passage2010P1Entry?.otherMeanings ?? []), ...mergedMeanings])),
