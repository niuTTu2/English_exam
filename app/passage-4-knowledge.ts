...
const definitions: Definition[] = [
  ...
  d("primary-reason-for-being", "primary reason for being", "one's reason for being", "名词 + 介词短语", "存在的首要理由", "reason 的后置修饰", "for being 中 being 是介词 for 的动名词，说明理由所针对的存在状态。", "Service was his primary reason for being.", "服务他人是他存在的首要理由。", ["being 在此是动名词，不是 be 的进行时；不要漏掉 for。"]),
  ...
  d("has-come-centralization", "has come centralization", "with X has come Y", "倒装结构", "集中化随之而来", "前置介词短语后的完全倒装", "正常语序是 centralization has come with economic growth；地点/背景短语前置后主语置于 come 之后。", "With reform has come greater transparency.", "随着改革，更高的透明度出现了。", ["倒装后 has come 仍与 centralization 一致；不要把 has 当作 centralization 的后置修饰。"]),
