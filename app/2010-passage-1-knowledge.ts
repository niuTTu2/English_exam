...
const seeds: Seed[] = [
  ...
  ["called out bids", "call out + bids", "高声报出竞价", "时间从句谓语", "call out 表大声喊出，bid 是竞价。"],
  ["one of the oldest banks", "one of + the + superlative + plural noun", "最古老的银行之一", "主语同位说明", "one 为单数中心，of 后名词用复数。"],
  ...
  ["since 2003", "since + starting point", "自2003年以来", "时间起点状语", "since 接起点，常与完成时语境连用。"],
  ...
  ["five years earlier", "time + earlier", "五年前", "比较时间状语", "earlier 以文中的过去节点为参照。"],
