...
export function getSentenceWordContext(sentenceId: string | undefined, headword: string) {
  ...
  const override = translation2000ReviewedContexts[sentenceId]?.[headword] ?? translation2011TrainingContexts[sentenceId]?.[headword] ?? passage2001P1SourceContexts[sentenceId]?.[headword] ?? passage2001P2SourceContexts[sentenceId]?.[headword] ?? cloze2001SourceContexts[sentenceId]?.[headword];
