...
接手先读`docs/TRAINING_TEMPLATE.md`、`docs/SYNTAX_UPGRADE_PROGRESS.md`；35模块、556句中，已有25模块406句通过完整训练层检查及生产构建：2000 Text 1—5及翻译；2001完形及Text 1/2；2010 Text 1—4、Part B及翻译；2011 Text 1—3及写作A/B；2012 Text 1—3及写作A/B。其余10模块150句逐篇迁移中。累计623项逐句任务、57项地图回忆、405项阅读题语言拆解；2001完形另有20题干及80选项的来源词卡与逐项理由，不把词卡来源计成句法拆解。用户已授权直接更新所有已导入模块，无需逐篇确认。部署状态另见台账。
