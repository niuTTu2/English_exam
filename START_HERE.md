...
暂停批量铺文章，先完成2010 Text 1“初读—精读—做题—复盘”样板。19句精确句法、35项主动任务、5段篇章地图和5题多句证据已提交；实际页面验收及剩余限制见 `docs/SYNTAX_UPGRADE_PROGRESS.md`。接手先读 `docs/TRAINING_TEMPLATE.md`，通过样板验收后给Text 2补齐完整训练层，再继续其他文章。Text 2原有19句阅读关系不等于模板全部完成。
