...
同事可将 `PROMPT_FOR_FRIEND_GPT.md` 全文交给 Codex。原卷附件不会自动随 Git 克隆；缺少时请提供原文件，不要依赖上一会话的临时路径。2010 年英语二全部阅读已完成：Text 1—4及Part B（21—45，共96句、25题）。本轮不扩展翻译和写作；提交与公开生产页核验状态以进度台账、交付消息和Git为准。
